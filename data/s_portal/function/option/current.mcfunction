...
execute if data storage shrs:context Portal_Maker.option{tp_particle:0b} run data modify storage shrs:temp Portal_Maker.option.tp_particle set value "OFF"
execute if data storage shrs:context Portal_Maker.option{tp_particle:1b} run data modify storage shrs:temp Portal_Maker.option.tp_particle set value "ON"

tellraw @s [{"text":"--------------------\n\n"},{"color":"aqua","text":"[Portal_Maker]\n\n"},"Overworldのみ設置可能 : ",{"nbt":"Portal_Maker.option.only_overworld","storage":"shrs:temp"},"\n攻撃時にポータルを除去 : ",{"nbt":"Portal_Maker.option.remove_attack","storage":"shrs:temp"},"\n水中にポータル設置可 : ",{"nbt":"Portal_Maker.option.place_underwater","storage":"shrs:temp"},"\n転移時パーティクル(自分にだけ表示) : ",{"nbt":"Portal_Maker.option.tp_particle","storage":"shrs:temp"},{"text":"\n\n--------------------"}]
