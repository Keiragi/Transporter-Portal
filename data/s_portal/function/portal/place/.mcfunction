## ポータル設置
  ...
  # 他にあるか調べる
    function s_portal:portal/place/check with storage minecraft: "S_Portal_Maker"
    execute if data storage minecraft: "S_Portal_Maker"{"Number":2b} run function s_portal:portal/remove/ with storage minecraft: "S_Portal_Maker"
